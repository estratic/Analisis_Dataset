...
```
Podemos concluir que las únicas variables que contienen los valores vacios son *self_employed* con un total de 18 (valor TRUE) y  *work_interfere* con 264 (Valor TRUE).
